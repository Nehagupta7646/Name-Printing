    ...
    for i in range(len(name)):
       # A
        ...
        #E
            ...
            for row in range(7):
                for col in range(6):
                    if(col==0 )or (row==0 or row ==6) or (row == 3 and col!=4 and col!=5):
                        print_E[row][col] = "*"
        ...
        #F
            ...
            for row in range(7):
                for col in range(6):
                    if(col==0 or row==0) or (row == 3 and col!=4 and col!=5):
                        print_F[row][col] = "*"
        ...
        #G
            ...
            for row in range(7):
                for col in range(6):
                    if(col==0 or row==0 or row ==6) or (row ==3 and col!=1 and col!=2) or (row==4 and col==5) or(row==5 and col==5):
                        print_G[row][col] = "*"
        ...
        #I
            ...
            for row in range(7):
                for col in range(6):
                    if(col==3)or (row==0 and col!=0) or (row == 6 and col!=0):
                        print_I[row][col] = "*"
        ...
        #J
            ...
            for row in range(7):
                for col in range(6):
                    if(col==3 and row !=6)or (row==0 and col!=0 and col!=5) or (row == 6 and col>0 and col<3) or (row ==4 and col==0) or (row ==5 and col==0):
                        print_J[row][col] = "*"
        ...
        #M 
            ...
            for row in range(7):
                for col in range(6):
                    if col==0 or col==4 or (row==col and col<3) or (row==1 and col==3):
                        print_M[row][col] = "*"
        ...
        #P
            ...
            for row in range(7):
                for col in range(6):
                    if(col==0 )or (row==0 or row ==3) and (col!=5) or (row ==2 and col == 5) or (row==1 and col==5):
                        print_P[row][col] = "*"
        ...
        #Q
            ...
            for row in range(7):
                for col in range(6):
                    if (col==0 or col==5) and(row>0 and row<5)or ((row==0 or row==5)and (col>0 and col<5) or (row==4 and col==1) or (row==6 and col==3)):
                        print_Q[row][col] = "*"
        ...
        #R
            ...
            for row in range(7):
                for col in range(6):
                    if(col==0) or(col==5 and(row!=0 and row!=3) or (row==0 or row==3) and col>0 and col<5):
                        print_R[row][col] = "*"
        ...
        #U
            ...
            for row in range(7):
                for col in range(6):
                    if(col==0 and row !=6 ) or (col==5 and row!=6) or(row==6 and col>0 and col<5):
                        print_U[row][col] = "*"
        ...
        #W
            ...
            for row in range(7):
                for col in range(6):
                    if(col==0 or col==5) or (row+col==6 and row>3) or (row==5 and col==4):
                        print_W[row][col] = "*"
